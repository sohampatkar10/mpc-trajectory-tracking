 ...
 * 
 *  Matrix containing 10 reference/measurement vectors of size 22 for first 10 nodes.
 */
real_t y[ 220 ];
...
/** Row vector of size: 374 */
real_t rk_xxx[ 374 ];

/** Matrix of size: 4 x 368 (row major format) */
real_t rk_kkk[ 1472 ];
...
real_t conAuxVar[ 324 ];

/** Row vector of size: 22 */
real_t conValueIn[ 22 ];

/** Row vector of size: 92 */
real_t conValueOut[ 92 ];
...
/** Matrix of size: 110 x 60 (row major format) */
real_t A[ 6600 ];
